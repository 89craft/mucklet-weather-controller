...
import { CmdArgs, TransitionData, WeatherStateData } from "./_/data-types";
import { listenerRoomScripts, commandWhiteList, defaultWeatherKeyword, timeScale } from "./_/config";
import { StoreKey, TopicKeyword, WeatherKeyword } from "./_/const";
import { storeSetBool, storeGetBool, randomDescribe, randomTransitionKey, randomDelay } from "./utils";
// import { Controller } from "./controller";
// import { ControllerAmbience } from "./controller/ambience";
// import { ControllerWeather } from "./controller/weather";
...
// Controller.setWeatherStates(weatherStates);
// ControllerWeather.setWeatherStates(weatherStates);
// ControllerAmbience.setWeatherStates(weatherStates);

// // ROOM SCRIPT FUNCTIONS
// // onActivate is called when the script is enabled.
// export function onActivate(): void {
// 	Controller.onActivate(weatherStates);
// }
...
// 	cmdAction: CmdAction,
// ): void {
// 	Controller.onCommand(weatherStates, addr, cmdAction);
// }
...
// 	sender: string,
// ): void {
// 	Controller.onMessage(weatherStates, addr, topic, data, sender);
// }
...
namespace ControllerWeather {
	...
	function setWeather(newWeatherKeyword: string): void {
		...
		const newWeatherValid = weatherStates.has(newWeatherKeyword);
